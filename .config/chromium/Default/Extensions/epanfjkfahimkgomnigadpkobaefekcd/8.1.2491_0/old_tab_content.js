 ...
 *
 */
!function(){try{var e=document.documentElement;try{var t=document.createEvent("Event");t.initEvent("dntme_unload",!0,!0),document.defaultView.dispatchEvent(t)}catch(e){}delete e.attributes.idmeScript,delete ABINE_DNTME,delete require,delete define}catch(e){}chrome.extension.sendRequest({eventName:"injectContentScript",payload:{file:"content.js",allFrames:!1,runAt:"document_idle"}})}();
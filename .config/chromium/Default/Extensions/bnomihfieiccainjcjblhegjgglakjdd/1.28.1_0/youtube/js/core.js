...
document.addEventListener('itVideoVolume', function() {
    if (settings.forced_video_volume != 'true') {
        settings.video_volume = Math.floor(document.querySelector('video').volume * 100);
